...
// Use chainlink functions to get product information. the function takes in product id and
// quantity to get the price and stock. Next the total price in usd is calculated and finally,
// the totalprice in SLC and AVAX is emitted depending on the enum selected.
// 
